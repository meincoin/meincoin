...
Setup
-----
Unpack the files into a directory and run meincoin-qt.exe.

If you have Microsoft Security Essentials, you need to add meincoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select meincoin-qt.exe, OK, Save changes.
